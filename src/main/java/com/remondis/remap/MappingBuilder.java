...
/**
 * The {@link MappingBuilder} object is used to specify the mapping of the fields from a source object/type
 ...
 * If there are unmapped properties in source/destination type, the {@link MappingBuilder#mapper()} throws
...
public final class MappingBuilder<S, D> {
  ...
  MappingBuilder(Class<S> source, Class<D> destination) {
    this.source = source;
   ...
   * @param mapper
   *        A mapper
   * @return Returns this {@link MappingBuilder} object for further configuration.
   */
  public MappingBuilder<S, D> useMapper(Mapper<?, ?> mapper) {
   ...
   * @return Returns this {@link MappingBuilder} object for further configuration.
   */
  public MappingBuilder<S, D> useMapper(TypeMapping<?, ?> typeMapping) {
