...
public class MappingException extends RuntimeException {
  ...
  static MappingException notAProperty(Class<?> type, String property) {
    return new MappingException(
            String.format("The get-method for property '%s' in type %s is not a valid Java Bean property.", property,
                    type.getName()));
  }
  ...
  static MappingException incompatiblePropertyTypes(Transformation t, PropertyDescriptor sourceProperty,
    ...
    return new MappingException(String.format(
            "The transformation %s cannot be applied on the incompatible property types\n%s\nand %s", t.getClass()
                    .getSimpleName(),
            asStringWithType(sourceProperty), asStringWithType(destinationProperty)));
  }
  ...
  static MappingException denyReassignOnMaps(PropertyDescriptor source, PropertyDescriptor dest) {
    return new MappingException(String.format(
            "The implicit mapping of maps is not supported. Use a replace operation for properties holding maps."
