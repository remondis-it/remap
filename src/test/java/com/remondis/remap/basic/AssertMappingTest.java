...
class AssertMappingTest {
  ...
  void shouldDenyIllegalArguments() {
    ...
    assertThatThrownBy(() -> AssertMapping.of(null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();

    assertThatThrownBy(() -> AssertMapping.of(mapper)
        .expectReassign(null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();
    ...
    assertThatThrownBy(() -> AssertMapping.of(mapper)
        .expectReassign(A::getString)
        .to(AResource::getAnotherString)
        .expectReplace(null, AResource::getIntegerAsString)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();

    assertThatThrownBy(() -> AssertMapping.of(mapper)
        .expectReassign(A::getString)
        .to(AResource::getAnotherString)
        .expectReplace(A::getInteger, null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();
    ...
    assertThatThrownBy(() -> AssertMapping.of(mapper)
        ...
        .andTest(null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();
    ...
    assertThatThrownBy(() -> AssertMapping.of(mapper)
        ...
        .expectOmitInSource(null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();
    ...
    assertThatThrownBy(() -> AssertMapping.of(mapper)
        ...
        .expectOmitInDestination(null)).isInstanceOf(IllegalArgumentException.class)
        .hasNoCause();
