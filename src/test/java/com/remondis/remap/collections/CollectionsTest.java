...
public class CollectionsTest {
	...
	public void shouldCheckForRequiredMappers() {
		Mapping.from(A.class).to(AResource.class).mapper();
	}
	...
	public void shouldMapNestedCollections() {
		...
		Mapper<B, BResource> bMapper = Mapping.from(B.class).to(BResource.class).mapper();
		Mapper<A, AResource> aMapper = Mapping.from(A.class).to(AResource.class).useMapper(bMapper).mapper();

		String[] stringsArr = new String[] { "A", "B", "C", "D" };
	...
	public void shouldMapCollections() {
		...
		Mapper<B, BResource> bMapper = Mapping.from(B.class).to(BResource.class).mapper();
		Mapper<A, AResource> aMapper = Mapping.from(A.class).to(AResource.class).useMapper(bMapper)
				.omitInSource(A::getNestedLists).omitInDestination(AResource::getNestedLists).mapper();
